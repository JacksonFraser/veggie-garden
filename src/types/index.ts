...
export function isValidPlantStatus(status: string): status is "planned" | "planted" | "growing" | "harvested" {
  return ["planned", "planted", "growing", "harvested"].includes(status);
}

export function isValidMaterial(material: string): material is "wood" | "stone" | "metal" | "composite" {
